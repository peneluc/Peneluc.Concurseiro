```markdown
# IoT ThermalBreak Web Backend

Backend responsável por disponibilizar dados de **Pause Mirror** para consumo da aplicação Web do módulo ThermalBreak.
...
dotnet restore
dotnet build
dotnet run --project IoT.ThermalBreak.Web.Backend.Api
```
